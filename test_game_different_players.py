...
import player_tft
import player_always_cooperate
...
# create the players
playerA = player_tft.MyPlayer(payoff_matrix, number_of_iterations);
# at the moment, me and the opponent are of the same type
playerB = player_always_cooperate.MyPlayer(payoff_matrix, number_of_iterations);
...
print('player A history ', playerA.history )
